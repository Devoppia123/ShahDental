...
<head>
    ...
    <link rel="stylesheet" href="{{ url('public/patient/style.css') }}">

    <link rel="stylesheet" href="{{ url('public/patient/css/responsive.css') }}">

    <script src="{{ url('patient/js/vendor/modernizr-2.8.3.min.js') }}"></script>
