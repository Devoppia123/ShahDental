<div id="header-inner" class="main-section">
        ...
        <div class="header-txt-blk all-txt-blk">
            ...
            <div id="banner-block-01 row">
                <div class="inner-heading">
                    <h1>We Are <strong>Creating </h1>
                    {{-- <a href="{{ url('/make-an-appointment') }}">Get Started 
                      <img class="cus-img"
                            src="{{ url('public/images/Shah-Dental_10.jpg') }}" alt="">
                    </a> --}}
                </div>
            </div>            
        </div>
