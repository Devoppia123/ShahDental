                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    <div class="inner-pg-cont">
                        <div class="inner-container">
                            <h2 class="main-head">Book An <span>Appointment</span></h2>
                            <form action="{{ url('/doctor/booked_appintment') }}" method="POST">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 services-col-multi">
                                        <label for="passport-input" class="passport_no" style="margin-left:15px"
                                            id="passport">
                                            Passport
                                            Number:
