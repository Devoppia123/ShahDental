        ...
        <div class="container-fluid">
            ...
            <div class="doc-slot-main">
                <div class="veiw-monthly-schedule row2">
                    <a href="{{ url("/doctor/view_current_month_booking/$Month_start/$Month_end") }}">Current Month
                        Booking
                        Slots</a>
                    <a href="{{ url("/doctor/view_current_week_booking/$weekStartDate/$weekEndDate") }}">Current Week
                        Booking Only</a>
                    <a href="{{ url("/doctor/view_current_day_booking/$current_date") }}">Today Booking Only</a>
                </div>
            </div>
        </div>
    </div>
