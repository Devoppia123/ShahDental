                ...
                <div class="row">
                    ...
                    <div class="col-lg-11">
                        <div class="baner-inner-text">
                            <h2>Thanks For Book An Appointment</h2>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="main-content-section">
        <div class="container">
            <div class="Cardiology">
                <h2 style="font-weight: 700; padding: 20px" class="text-center">Thanks For Book An Appointment</h2>
            </div>
            <div>
                <h4 class="text-center">Please Check Your Email</h4>
                <div style="text-align: center; margin: 20px">
                    <a href="http://www.essamtalks.com/shah-dental/" class="btn btn-primary text-center">Back To
                        Home</a>
                </div>
            </div>
    </section>
