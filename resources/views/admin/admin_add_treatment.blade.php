                        ...
                        <form class="form-horizontal" method="post" action="{{ url('/admin/add-treatment-post') }}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" type="text" required name="treatment_name" class="txt-field"
                                        size="35" maxlength="130" />
                                </div>

                                <div class="col-md-6">
                                    <label>TOOTH NUMBER :</label>
                                    <input class="form-control" type="text" required name="tooth_number" class="txt-field"
                                        size="35" maxlength="130" />
                                </div>
