...
@section('content')
    <div class="main-cont-wrapper">
        <div class="container-fluid">
            <div class="mt-5 mb-5">
                <a class="btn btn-success" href="{{ url('/admin/add-investigation') }}">Add Investigation</a>
            </div>
            <div class="mt-3">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-success"
                                        href="{{ url('/admin/edit-investigation') }}/{{ $list->id }}">Edit</a>

                                    <a class="btn btn-danger"
                                        href="{{ url('/admin/deleted-investigation') }}/{{ $list->id }}">Deleted</a>
                                </td>
                            </tr>
                        @endforeach
