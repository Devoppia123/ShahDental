                        ...
                        <form class="form-horizontal" method="post" action="{{ url('/admin/add-procedure-post') }}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" value="{{$procedures->name}}" type="text" required name="name" class="txt-field"
                            ...
                            <input class="btn mt-3 btn-info" name="procedures" style="margin-top: 5px" type="submit" value="Update">
