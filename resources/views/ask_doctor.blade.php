...
@section('content')
    ...
    <div class="rk-form-bg">
        <div class="container reh-contact-form" style="padding-top: 50px">
            <form action="{{ url('submit_question') }}" method="post" id="ask-doc-form" class="ask-doc-form">
                @csrf
                <div class="row g-3">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <input type="text" name="full_name" id="full_name" placeholder="Enter your full name"
                            class="form-control">
                        <p class="invalid-feedback" id="error-full_name"></p>
                    </div>
                    <div class="col-md-6 col-sm-12">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="radio" name="subject" value="inquiry" class="form-check-input"
                                id="subject-inquiry">
                            <label for="subject-inquiry">Inquiry</label>
                            <input type="radio" name="subject" value="general" class="form-check-input"
                                id="subject-general">
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            $("#ask-doc-form").submit(function(event) {
                    ...
                    success: function(response) {
                        ...
                        if (response["status"] == true) {
                            ...
                            if (errors['full_name']) {
                                ...
                                $("#error-full_name").html(errors['full_name'][0]);
                            }
                            if (errors['phone']) {
